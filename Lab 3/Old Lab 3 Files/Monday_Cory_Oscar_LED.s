...
patern2State::		.blkb 1     ; Pattern 2 State Variable
...
;		
;======================== Display State 10 - Value Too Big Print    ====================
;
...
timing1state1:                         ; (re)initialize COUNT_1
        movw   pattern1ticks, pattern1Count
        ldx    pattern1Count
        dex                       ; decrement COUNT_1
        stx    pattern1Count            ; store decremented COUNT_1
        clr    pattern1Done
...
timing1state2:                         ; count down COUNT_1
        ldx    pattern1Count
...
timing2state0:                         ; initialization for TASK_5
        clr    pattern2Done
        movb   #$01, timing2State     ; set next state
        rts
...
timing2state1:                         ; (re)initialize COUNT_1
        movw   pattern2ticks, pattern2Count
        ldx    pattern2Count
        dex                       ; decrement COUNT_1
        stx    pattern2Count            ; store decremented COUNT_1
        clr    pattern2Done
...
timing2state2:                         ; count down COUNT_1
        ldx    pattern2Count
...
SET_DONE_2:
        ...
        movb   #$01, pattern2Done       ; if done, set DONE_1 flag
        movb   #$01, timing2State      ; set next state
