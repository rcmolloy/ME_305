...
TC0_ISR:
    ...
    tst    loopSetFlag                    ; Test loopSetFlag
    bne    OPEN_LOOP_INIT                 ; If Open Loop Desired, Branch to OPEN_LOOP_INIT
	movw   oldKi,Ki                       ; Move Previoulsy Saved Ki into the New Ki
...
OPEN_LOOP_INIT:
    ...
    tst	   firstKiFlag                    ; Test firstKiFlag (First Time Around in Open Loop)
	bne	   OLD_KI_SET                     ; If not the First Time Around in Open Loop, Branch to OLD_KI_SET
	bra	   OPEN_LOOP_START                ; If First time, Branch to OPEN_LOOP_START
	
OPEN_LOOP_START:

	movw   #$0000, Ki                     ; Clear Ki
 ...
 OLD_KI_SET:
 	...
 	movb   #$00,firstKiFlag               ; Clear firstKiFlag
	movw   Ki, oldKi                      ; Make Current Ki as Old Ki
	bra    OPEN_LOOP_START                ; Branch to OPEN_LOOP_START
