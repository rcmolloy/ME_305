...
F1_TRUE:
	...
	beq		F1_DONE						 ; If VRefSignFlag is 0 (False), Branch to F1_DONE
...
F2_TRUE:
	...
	tst		VRefSignFlag				 ; Test VRefSignFlag
	beq		F2_DONE						 ; If VRefSignFlag is 0 (False), Branch to F2_DONE
	tst		digitCounter				 ; Test digitCounter
...
VACT_SIGN_CHECK:
	...
	beq    	POS_SIGN					  ; If VActSign is 0 (Positive), Branch to NEG_SIGN
 	movb   	#$01, VActSign				  ; Set VActFlag to 1 (Negative)
...
ERROR_SIGN_CHECK:
	...
	movb   	#$01, errorSign			      ; Set errorSign to 1 (Negative)
	bra	  	NEG_SIGN                      ; Branch Always to NEG_SIGN    		                           		   
